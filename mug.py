...
class Mug(Mesh):
    def geo(self):
        ...
        geo += """
                ...
                Physical Surface(1) = {1,"""+",".join([str(i) for i in range(9,44)])+"""};
                Physical Surface(2) = {"""+",".join([str(i) for i in range(2,8)])+"""};
                """
        return geo
...
class Mug2(Mesh):
    def geo(self):
        ...
        geo += """
                ...
                Physical Surface(1) = {1,"""+",".join([str(i) for i in range(8,44)])+"""};
